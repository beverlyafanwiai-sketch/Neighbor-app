  ...
  return (
    <SafeAreaView className="flex-1 bg-sand" edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="px-5 pb-10">
        ...
        <View className="gap-3">
          <Pressable
            onPress={() => router.push('/neighborhood-pulse')}
            className="flex-row items-center gap-3 rounded-2xl bg-cream p-4 active:opacity-80"
          >
            <Ionicons name="pulse-outline" size={18} className="text-charcoal" />
            <Text className="flex-1 text-sm font-medium text-charcoal">Neighborhood Pulse</Text>
            <Ionicons name="chevron-forward" size={16} className="text-charcoal/50" />
          </Pressable>
          ...
          <Pressable
            ...
            className="flex-row items-center gap-3 rounded-2xl bg-cream p-4 active:opacity-80"
          >
            <Ionicons name="call-outline" size={18} className="text-charcoal" />
            <Text className="flex-1 text-sm font-medium text-charcoal">Local Resources</Text>
            <Ionicons name="chevron-forward" size={16} className="text-charcoal/50" />
          </Pressable>
